...
class RegistrationController extends BaseController {
    ...
    public function registerAction(Request $request) {
        ...
        if ($pass != NULL) {
            /*
             * CASE :
             * User already exist. He want to register with another key or connect with one he already register with.
             */
        ...
        if ($lastName == NULL) {
            ...
            $this->endRegister($mail, $mail2, $pass1, $pass2, $lastName, $firstName, $jobCity, $homeCity, $organisation, $getSeminar, $getStatus);
        }
    ...
    function endRegister($mail, $mail2, $pass1, $pass2, $lastName, $firstName, $jobCity, $homeCity, $organisation, $seminar, $status)
    {
