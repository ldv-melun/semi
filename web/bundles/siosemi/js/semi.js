...
function updateStatMeetings(data) {
  ...
  if (data.statNbUsers > 1) {
    $('#statNbUsers').html("<b>" + data.statNbUsers + "</b> participants.");
  } else {
    $('#statNbUsers').html("<b>" + data.statNbUsers + "</b> participant.");
  }
}
