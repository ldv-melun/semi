function showLogin()
{
    ...
    label.animate({opacity: 0}, 500, function () {
        label.html("<h2>Connexion</h2>");
    ...
    switchLabel.animate({opacity: 0}, 500, function () {
        switchLabel.html('<p class="connexion" onClick="showRegister();">... Ou cliquez ici pour vous enregistrer !</p>');
        switchLabel.animate({opacity: 1}, 500);
    });
    form.animate({opacity: 0}, 500, function () {
        form.html('<form action="login_check" method="post">'
...
function showRegister()
{
    ...
    label.animate({opacity: 0}, 500, function () {
        label.html("<h2>Inscription</h2>");
        label.animate({opacity: 1}, 500);
    });
    help.animate({opacity: 0}, 500, function () {
        help.html('<p class="help">* Une clé d\'inscription à un séminaire est nécessaire pour s\'enregistrer.<br></p>');
        help.animate({opacity: 1}, 500);
    });
    switchLabel.animate({opacity: 0}, 500, function () {
        switchLabel.html('<p class="connexion" onClick="showLogin();">... Ou cliquez ici pour vous connecter !</p>');
        switchLabel.animate({opacity: 1}, 500);
    });
    form.animate({opacity: 0}, 500, function () {
        form.html('<form action="register" method="post">'
                + '<div class="input-group">'
                + '<span class="input-group-addon" id="basic-addon1">></span>'
